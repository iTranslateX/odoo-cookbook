...
1. 在数据库管理页面，点击Duplicate Database：
   [![Duplicate Database](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050515123745.jpg)](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050515123745.jpg)图1.7 – 复制数据库对话框
2. 填写表单如下：
...
1. 在数据库管理页面，点击想删除的数据库名称旁的Delete Database链接，会出现下图中的对话框：
   [![Delete Database](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050515230631.jpg)](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050515230631.jpg)图1.8 – 删除数据库弹窗
...
1. 在数据库管理页面，点击想备份数据库名称旁的Backup按钮，会弹出下图这样的对话框：
   [![Backup Database](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050516024419.jpg)](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050516024419.jpg)图1.9 – 备份数据库弹窗
2. 填写表单
...
1. 在数据库管理页面，点击页面底部的Restore Database按钮，会弹出如下的对话框：
   [![Restore Database](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050516123082.jpg)](https://alanhou.org/homepage/wp-content/uploads/2019/05/2019050516123082.jpg)图1.10 – 还原数据库对话框
2. 填写表单：
   - Master Password：这是Odoo服务的主控密码。
   - File：这是之前所下载的Odoo备份
