...
参见[第四章 创建Odoo插件模块](4.md)中*添加模型*一节获取更详细信息。
...
2. 修改change_state方法并抛出else部分中的UserError异常：
...
在[第五章 应用模型](5.md)中的*使用继承向模型添加功能*一节，我们学习了如何在已有模型中添加字段。在这个模型中，继承library.book模型如下：
